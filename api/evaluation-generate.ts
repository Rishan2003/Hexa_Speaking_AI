...
- The final script should be easy to listen to aloud and should feel like one teacher talking directly to one learner. Do not use regional dialect, slang, or over-friendly terms such as ভাই/ব্রো.`;
  ...
  ? `Also create voiceFeedbackBangla: a concise, natural spoken coaching review in Bangladeshi Bangla, targeting 170-190 words and lasting about 70-85 seconds. This is a FULL IELTS Speaking test. Use only transcript-grounded evidence and prioritize the patterns that would most improve the learner's performance. Do not state the overall practice estimate. Begin with one brief overall interpretation. Then review Part 1, Part 2, and Part 3 in order, giving each part one compact, useful observation supported by a specific example or correction where available. Use Part 2 metadata only when relevant. Across the review, address only supported evidence about Fluency and Coherence, Lexical Resource, and Grammatical Range and Accuracy. For Part 3, mention explaining, justifying, comparing, generalizing, or handling abstract ideas only when demonstrated. Briefly connect the most important recurring pattern across the whole test. Naturally identify the learner's two strongest points and three highest-priority improvements, then finish with a specific 7-day practice direction targeting those weaknesses. Prefer depth on the most diagnostic examples over covering every possible subcategory. Do not invent wording or performance. Do not discuss pronunciation or any category that cannot be assessed from the transcript. Do not use markdown, bullet symbols, emojis, headings, or English-only sentences. Keep strictly within the target length and write as connected spoken feedback, not a list.`
  : `Also create voiceFeedbackBangla: a concise, natural spoken coaching review in Bangladeshi Bangla, targeting 155-175 words and lasting about 65-80 seconds. This is an INDIVIDUAL IELTS Speaking part, so discuss only the part taken and never refer to untested parts. Use only transcript-grounded evidence and prioritize the patterns that would most improve the learner's performance. Do not state the overall practice estimate. Begin with one brief overall interpretation. In connected spoken prose, discuss Fluency and Coherence, Lexical Resource, and Grammatical Range and Accuracy using one specific observation or example for each category where evidence is available. Include a correction or more natural expression for the most important problem. Naturally identify the learner's two strongest points and three highest-priority improvements, then finish with a specific 7-day practice direction targeting the recurring weaknesses. Prefer a few diagnostic examples over broad or repetitive commentary. Do not invent wording or performance. Do not discuss pronunciation or any category that cannot be assessed from the transcript. Do not use markdown, bullet symbols, emojis, headings, or English-only sentences. Keep strictly within the target length and write as connected spoken feedback, not a list.`;
